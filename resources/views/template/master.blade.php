...
<body>
    ...
    <div id="preloader">
        ...
        <img src="{{ asset('/template/img/core-img/salad.png')}}" alt="">
    </div>
                                        ...
                                        <div class="megamenu">
                                            ...
                                            <div class="single-mega cn-col-4">
                                                <div class="receipe-slider owl-carousel">
                                                    <a href="#"><img src="{{ asset('/template/img/bg-img/bg1.jpg')}}" alt=""></a>
                                                    <a href="#"><img src="{{ asset('/template/img/bg-img/bg6.jpg')}}" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
    ...
    <div class="follow-us-instagram">
        ...
        <div class="insta-feeds d-flex flex-wrap">
            ...
            <div class="single-insta-feeds">
                <img src="{{ asset('/template/img/bg-img/insta1.jpg')}}" alt="">
                <!-- Icon -->
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="{{ asset('/template/img/bg-img/insta2.jpg')}}" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="{{ asset('/template/img/bg-img/insta3.jpg')}}" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="{{ asset('/template/img/bg-img/insta4.jpg')}}" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="{{ asset('/template/img/bg-img/insta5.jpg')}}" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="{{ asset('/template/img/bg-img/insta6.jpg')}}" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="{{ asset('/template/img/bg-img/insta7.jpg')}}" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
